...
@@ 212 - 32 = 180 / increments of 5 = 36 temperatures
@@ Each temperature value is 4 bytes, so
@@ 36 * 4 = skip 144 + 4 = skip 148

.align 4
fahrenheit_array:  .skip 148

.align 4
celcius_array: .skip 148

.align 4
factor: .word 0x8e38f

.align 4
msg: .asciz "%d fahrenheit is %d celsius\n"
...
fill_celcius_array:
	...
	mov r6, r0     @@ #36, or the total number of temperatures we are going to convert
...
main:
	...
	@@ Recall that #36 is the num of temperatures we are going to convert
